...
class Department {
    ...
    logEmployeeInfo(employee) {
        console.log(employee.firstName + " " + employee.secondName + " отримав " + employee.CalculateSalary() +
            " золото у якості заробітньої плати\n");
    }
}

let SeniorPomidorDeveloper = new Developer("Тарас", "Шевченко", 600, 6);
let MiddleDeveloper = new Developer("Він", "Дизель", 300, 3);
let SeniorDesigner = new Designer("Іван", "Мазепа", 500, 4, 0.72);
let JuniorDesigner = new Designer("Богдан", "Хмельницький", 400, 1, 0.85);
...
let TopManager = new Manager("Стів", "Джобс", 900, 5, topManagerTeam);

let justManagerTeam = [];
justManagerTeam.push(JuniorDesigner);

let JustManager = new Manager("Віл", "Сміт", 800, 4, justManagerTeam);
